    ...
    !function(t, e) {
      ...
      return function(t) {
        ...
        class h {
          ...
          createToolbox() {
            const t2 = r("div", [h.CSS.toolbox, this.cssModifier ? `${h.CSS.toolbox}--${this.cssModifier}` : ""]), e2 = this.createPopover(), o2 = this.createToggler();
        ...
        class R {
          ...
          getCell(t2, e2) {
            return this.table.querySelector(`.${w}:nth-child(${t2}) .${x}:nth-child(${e2})`);
          }
          getRow(t2) {
          ...
          get numberOfColumns() {
            return this.numberOfRows ? this.table.querySelector(`.${w}:first-child`).childElementCount : 0;
          }
